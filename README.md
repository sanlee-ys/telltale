...
on-disk corpus on agy 1.1.9 ([docs/design.md §2.1/§3.8](docs/design.md)). **Cursor (Composer)** is
...
([docs/design.md §3.9](docs/design.md)). **`telltale council`** seats the 4-vendor fleet (Claude Code, Codex, Cursor, Antigravity), and every sandbox and streaming claim in it was measured
