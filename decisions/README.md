...
Repo-local ADRs. Cross-repo decisions live in the architecture repo (SYS-NNN).

| ADR | Title | Status |
|---|---|---|
| [001](001-v1-scope.md) | v1 scope, operating contract, and the Codex statusline fork | Accepted |
...
| [005](005-adoption-direction.md) | Adoption direction: multi-harness attention routing as product strategy | Proposed |
